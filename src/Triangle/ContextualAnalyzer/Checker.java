...
import Triangle.AbstractSyntaxTrees.ExpressionCommand;
...
public final class Checker implements Visitor {
  ...
  public Object visitExpressionCommand(ExpressionCommand ast, Object o) {
	...
	if (ast.E instanceof UnaryExpression ) {
  ...
  public Object visitBoolean(Boolean BOL, Object o) {
	    return StdEnvironment.booleanType;
	  }
  ...
  private void establishStdEnvironment () {
    ...
    StdEnvironment.implDecl = declareStdBinaryOp("->", StdEnvironment.booleanType, StdEnvironment.booleanType, StdEnvironment.booleanType);
    StdEnvironment.equiDecl = declareStdBinaryOp("<->", StdEnvironment.booleanType, StdEnvironment.booleanType, StdEnvironment.booleanType);
