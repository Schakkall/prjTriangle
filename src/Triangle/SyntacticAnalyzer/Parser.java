...
//a leaf AST to represent it.
  ...
  Boolean parseBoolean() throws SyntaxError {
	  Boolean BOL = null;
	  if (currentToken.kind == Token.BOOLEAN) {
		  previousTokenPosition = currentToken.position;
		  String spelling = currentToken.spelling;
		  BOL = new Boolean(spelling, previousTokenPosition);
		  currentToken = lexicalAnalyser.scan();
	  } else {
		  BOL = null;
		  syntacticError("boolean expected here", "");
	  }
	  return BOL;
  }
...
///////////////////////////////////////////////////////////////////////////////
  ...
  Expression parsePrimaryExpression() throws SyntaxError {
    ...
    case Token.BOOLEAN:
    {
      Boolean bolAST = parseBoolean();
      finish(expressionPos);
      expressionAST = new BooleanExpression(bolAST, expressionPos);
    }
    break;
